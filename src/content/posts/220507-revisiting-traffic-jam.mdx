...
decided to rebuild this blog that I never post on. As an example entry, I chose to re-implement
...
import Game from './_revisiting-traffic-jam/Game.tsx';

<Game numPlayers={8} client:load />
